...
SELECT certificate as rating, COUNT(series_title) as titles, ROUND(AVG(runtime), 0) as avg_runtime, 
	ROUND(AVG(gross), 0) as avg_gross, ROUND(AVG(CAST(imdb_rating AS NUMERIC)), 2) AS avg_imdb_rating,
